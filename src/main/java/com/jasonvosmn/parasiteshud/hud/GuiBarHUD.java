...
public class GuiBarHUD extends Gui {
    ...
    private static int cachedCooldown = 0;
    ...
    public static void updateFromPacket(int phase, int points, int next, int cooldown) {
        cachedStage = (byte) phase;
        cachedPoints = points;
        cachedPointsNextPhase = next;
